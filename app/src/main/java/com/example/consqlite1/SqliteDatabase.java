...
public class SqliteDatabase extends SQLiteOpenHelper {
    ...
    ArrayList<Contacts> listContacts() {
        //creamos la lista de contactos en un array de lista
    ...
    void addContacts(Contacts contacts) {
        ...
        db.insert(TABLE_CONTACTS, null, values);//insertamos registros
    }

//actualizamos el registro pasando un id
...
//eliinamos el registro pasando un id
